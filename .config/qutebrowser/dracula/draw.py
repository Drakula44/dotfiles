def blood(c, options = {}):
    ...
    c.colors.downloads.stop.bg = palette['cyan']
    ...
    c.colors.keyhint.fg = palette['red']
    ...
    c.colors.statusbar.command.private.bg = palette['purple']

    ## Foreground color of the statusbar in private browsing + command mode.
    c.colors.statusbar.command.private.fg = palette['background']
    ...
    c.colors.statusbar.passthrough.bg = palette['purple']
