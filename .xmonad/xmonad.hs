...
myStartupHook = do
          ...
          spawnOnce "picom &"
          spawnOnce "feh --bg-scale ~/home/images/bg/dracula.jpg &"
          -- spawnOnce "nm-applet &"
...
myKeys =
    -- Xmonad
        [ ("M-C-S-r", spawn "xmonad --recompile") -- Recompiles xmonad
    ...
    -- Look at "search engines" section of this config for values for "k".
        ++ [("M1-s " ++ k, S.promptSearch dtXPConfig' f) | (k,f) <- searchList ]
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/drakula/.config/xmobar/xmobarrc0"
